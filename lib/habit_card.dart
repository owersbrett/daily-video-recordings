...
//   const HabitCard({super.key, required this.habitEntity, required this.habitEntry, this.onCheck, this.onUncheck, this.progress = 100, this.checkable = true});
...
//                             ? StylizedCheckbox(isChecked: _checked, color: HexColor.fromHex(habit.hexColor), onTap: () => _onCheck(_completed))
